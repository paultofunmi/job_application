module.exports = {
  bind: function (app, assetPath) {
    ...
    app.get('/applicant', function (req, res) {
      var pageName = 'Applicant \'s Profile'; 
      console.log("success");      
      res.render('applicant', { 'page_name': pageName })
    })    
    //show all applicants
    app.get('/all-applicants', function (req, res) {
      var pageName = 'All Applicants' 
      res.render('applicants', {'page_name': pageName})
    })     
